              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: 30px auto;">
                <tr>
                  <td style="border-radius: 8px; background-color: #ff8c00; text-align: center; box-shadow: 0 4px 14px rgba(255, 140, 0, 0.3);">
                    <a href="${verifyUrl}" target="_blank" style="background-color: #ff8c00; border: 1px solid #ff8c00; border-radius: 8px; color: #1A1A1C; display: inline-block; font-size: 16px; font-weight: 700; padding: 14px 32px; text-decoration: none;">
